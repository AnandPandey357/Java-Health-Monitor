...
/**
 * Simplified JVMMonitor class - standalone version without external dependencies
 * This class monitors Java Virtual Machine metrics
 */
public class SimpleJVMMonitor {
    ...
    /**
     * Main method for testing the SimpleJVMMonitor class
     * This allows running the monitor as a standalone application
     */
    public static void main(String[] args) {
        System.out.println("Starting Java Application Health Monitor (Simplified Version)");
        System.out.println("============================================================");
        
        // Create an instance of SimpleJVMMonitor
        ...
        if (args.length > 0) {
            ...
            System.out.println("\nTo run continuous monitoring, provide an interval in seconds:");
            System.out.println("Example: java SimpleJVMMonitor 30");
        }
    }
}